...
- Configurable password policy — custom minimum length + required character-class count, or a built-in "BSI recommendation" mode (Germany's federal infosec agency) that mirrors its official three-tier guidance, including a relaxed tier for accounts with active 2FA/Passkey
