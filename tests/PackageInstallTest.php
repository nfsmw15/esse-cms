...
function cleanupPackageDir(string $slug, string $baseDir = 'plugins'): void
{
    $dir = dirname(__DIR__) . '/' . $baseDir . '/' . $slug;
...
return [
    ...
    // -- Iconpack: gleiche Funktion, gleiche Limits, andere Endungs-Allowlist und Zielverzeichnis --

    'packageInstallZip (iconpack): lehnt ZIP mit PHP-Datei ab (RCE-Schutz)' => function () {
        ...
        $result = packageInstallZip($zipPath, 'iconpack');
        @unlink($zipPath);
        ...
        try {
            ...
            cleanupPackageDir('evil-pack', 'public/vendor');
        }
    },

    'packageInstallZip (iconpack): akzeptiert ein normales Icon-Pack (json/css/woff)' => function () {
        ...
        try {
            ...
            cleanupPackageDir('good-pack', 'public/vendor');
        }
    },
];
